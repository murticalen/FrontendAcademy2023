...
Theme types are declared in [styled.d.ts](./styled.d.ts) file (which you should complete using Zeplin, of course), to have suggestions in your preferred editor.
