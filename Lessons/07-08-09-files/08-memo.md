Create a playground page on `/playground` path and add all of your random examples here. Let the page fetch event deatils of a selected event and work with the data.
